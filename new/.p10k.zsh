# Generated by Powerlevel10k configuration wizard on 2024-06-17 at 17:10 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    pyenv context_joined                   # python environment (https://github.com/pyenv/pyenv)
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=003
