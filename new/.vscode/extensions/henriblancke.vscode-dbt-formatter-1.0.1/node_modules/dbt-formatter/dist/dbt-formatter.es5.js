import { isEmpty, escapeRegExp, last, repeat, trimEnd } from 'lodash';
...
var Tokenizer = /** @class */ (function () {
    ...
    Tokenizer.createLineCommentRegex = function (ids) {
        return new RegExp("^((?:" + ids.map(function (id) { return escapeRegExp(id); }).join('|') + ").*?(?:\n|$))");
    };
...
var Indentation = /** @class */ (function () {
    function Indentation(indent) {
        ...
        this.getIndent = function () {
            return repeat(_this.indent, _this.indentTypes.length);
        };
        /**
        ...
        this.decreaseTopLevel = function () {
            if (last(_this.indentTypes) === INDENT_TYPE_TOP_LEVEL) {
    ...
    function Formatter(opt) {
        ...
        this.formatOperator = function (node, query) {
            ...
            if (prevToken && prevToken.item.type === tokenTypes.OPERATOR) {
                return trimEnd$1(query) + removeWhitespace(token.value) + ' ';
            }
            return _this.formatWithSpaces(node, query);
        };
...
//# sourceMappingURL=dbt-formatter.es5.js.map
